      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          <div className="flex flex-wrap items-center justify-center gap-6">
            <Link href="/#apps" className="text-sm text-zinc-500 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">Apps</Link>
            <Link href="/articles" className="text-sm text-zinc-500 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">Articles</Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/vladblajovan" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-zinc-400 transition hover:text-[#333] dark:hover:text-white">
            ...
            <a href="https://www.linkedin.com/in/vlad-blajovan" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-zinc-400 transition hover:text-[#0A66C2] dark:hover:text-[#0A66C2]">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="https://www.threads.com/@vladblajovan" target="_blank" rel="noopener noreferrer" aria-label="Threads" className="text-zinc-400 transition hover:text-zinc-900 dark:hover:text-white">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/vladblajovan/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-zinc-400 transition hover:text-[#E4405F] dark:hover:text-[#E4405F]">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <a href="https://www.buymeacoffee.com/vladblajovan" target="_blank" rel="noopener noreferrer">
            ...
            <img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style={{ height: '40px' }} loading="lazy" />
          </a>
